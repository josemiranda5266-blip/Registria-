        ...
        <div className="max-w-7xl mx-auto px-4 py-3 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center flex-wrap gap-2 text-xs">
            ...
            <button
              ...
              className="flex items-center gap-2 bg-slate-800 hover:bg-slate-700 px-3 py-1.5 rounded-lg border border-slate-700 text-slate-200 transition-all cursor-pointer"
            >
              <UserCheck className="w-3.5 h-3.5 text-blue-400" />
              <div className="text-left">
                <p className="font-bold text-white text-[11px] leading-none">
                  {currentUser ? currentUser.name : 'Iniciar Sesión'}
                </p>
                <p className="text-[9px] text-slate-400 leading-tight">
                  Rol: {currentUser ? currentUser.role : userRole}
                </p>
              </div>
            </button>
          </div>
